...
<div id="container">
    <div id="one_maincolumn" class="main_column">
                            ...
                            <form name="form1" id="form1" method="post" action="?" onsubmit="return checkReceiptNumber();">
                                    ...
                                    <table summary="指定送貨地址" class="product-table">
                                        ...
                                        <tr> 
                                            ...
                                            <td class="W10 t_center">
                                                <input type="radio" name="deliv_check" id="chk_id_1" value="-1"  />
                                            </td>
                                            ...
                                            <td class="W10 t_center" style="display: none">
                                            ...
                                            <td class="W17 mb_none" style="display: none">
                                                <label for="chk_id_<!--{$smarty.section.cnt.iteration}-->">
                                                    <!--{if $smarty.section.cnt.first}-->
                                                        會員註冊地址
                                                    <!--{else}-->
                                ...
                                <div class="border_round">
                                  ...
                                  <table summary="支払方法選擇付款方式" id="payment">
                                    <!-- FIXME: 假tr -->
                                    <tr >
                                        <td class="W25 top-15">選擇付款方式</th>
                                        <td class="W75">
                                          <div class="W100">
                                            <div class="inline">
                                              <input type="radio" id="pay_1" name="payment_id" value="1" style="">
                                              <label for="pay_1">貨到付款</label>
                                            </div>
                                            <div class="inline">
                                              <input type="radio" id="pay_2" name="payment_id" value="2" style="">
                                              <label for="pay_2">貨到付款</label>
                                            </div>
                                            <div class="inline">
                                              <input type="radio" id="pay_3" name="payment_id" value="3" style="">
                                              <label for="pay_3">貨到付款</label>
                                            </div>
                                          </div>

                                          <div id="card_info" style="<!--{if $paymentId != 1}-->display:none;<!--{/if}-->">
                                            <div id="card_used_flag" class="W100">
                                                <span class="attention"></span>
                                                <p class="attention">若使用別張卡片，則目前所有未出貨的定期訂單，往後將以此新卡號進行刷卡結帳。</p>
                                                <div class="W100">
                                                  <input type="radio" id="gmo_same_card" name="<!--{$key0}-->" value="0" />
                                                  <label for="gmo_same_card">使用同張信用卡&nbsp;</label>
                                                  <input type="radio" id="gmo_other_card" name="<!--{$key0}-->" value="1" />
                                                  <label for="gmo_other_card">使用別張信用卡​</label>
                                                </div>
                                                
                                                <div class="W100" style="<!--{if isset($is_gmo_used_flg|smarty:nodefaults) && $is_gmo_used_flg == 1 && $arrForm[$key0].value == 1}-->display:none;<!--{/if}-->">
                                                  前次刷卡號碼:12345677
                                                </div>
                                            </div>
                                            ...
                                            <div class="W100">
                                              <div style="background-color: #ffe8e8;padding: 12px;">
                                                ...
                                                <div class="attention" style="padding: 10px;"><!--{$gmo_error|h}--></div>
                                              </div>
                                            </div>
                                    ...
                                    <tr style="display:none;">
                                        ...
                                        <td class="W75">
                                          ...
                                          <div id="card_info" style="<!--{if $paymentId != 1}-->display:none;<!--{/if}-->">
                                            <!--{if $has_card_info_flg == '1'}-->
                                            <div id="card_used_flag" class="W100" style="<!--{if !isset($is_gmo_used_flg|smarty:nodefaults) || $is_gmo_used_flg == 0}-->display:none;<!--{/if}-->">
                                    ...
                                    <tr>
                                      ...
                                      <td class="W75">
                                        <span class="attention">錯誤訊息</span>
                                        <div class="W100">
                                          <span id="receiving_method_house_area" style="<!--{if $paymentId == 5}-->display:none;<!--{/if}-->">
                                            <input type="radio" id="receiving_method_house" name="receiving_method" value="0" /><label for="receiving_method_house">宅配&nbsp;&nbsp;</label>
                                          </span>
                                ...
                                <div class="border_round">
                                  <table>
                                    ...
                                    <tr>
                                      ...
                                      <!-- FIXME: 假td -->
                                      <td class="W75">
                                        <span class="attention W100">錯誤訊息</span>
                                        <div class="W100">
                                          <input type="radio" id="receipt_people" name="receipt_type" value="P"  /><label for="receipt_people">個人</label>
                                          <input type="radio" id="receipt_company" name="receipt_type" value="C"  /><label for="receipt_company">公司報帳用發票</label>
                                        </div>
                                        <div class="attention W100">錯誤訊息</div>
                                        <div class="W100">
                                      ...
                                      <!-- FIXME: 真td -->
                                      <td class="W75" style="display:none">
                                    ...
                                    <tr>
                                      ...
                                      <td class="W75">
                                        <span class="attention">錯誤訊息</span>
                                        <div class="W100">
                                          <input type="radio" id="<!--{$key}-->_1" name="<!--{$key}-->" value="1" /><label for="<!--{$key}-->_1">無載具</label>
                                          <input type="radio" id="<!--{$key}-->_0" name="<!--{$key}-->" value="0" /><label for="<!--{$key}-->_0">共通性載具</label>
                                        </div>

                                        <div id="<!--{$key}-->_area">
                                          <div class="attention W100">錯誤訊息</div>
                                          <ul class="W100">
                                            <li id="<!--{$key1}-->_li" class="inline"><input type="text" placeholder="手機條碼" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->"  class="box200" />&nbsp;</li>
                                            <li id="<!--{$key2}-->_li" class="inline"><input type="text" placeholder="自然人憑證條碼" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="box200"/></li>
                                          </ul>
                                        </div>
                                        ...
                                        <div id="donate_type_display" class="W100">
                                          ...
                                          <label>
                                            <input type="checkbox" name="donate_type" id="donate_type" value="1" checked="checked" />
                                            捐贈發票
                                          </label>
                                          
                                          <div id="<!--{$key}-->_area">
                                            <div class="attention W100"></div>
                                            <ul>
                                              ...
                                              <li style="display:none;">社福統編&nbsp;<input type="text" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->;" class="box200" /></li>
                                            </ul>
                                          </div>
                                        </div>
                                      </td>
                                      ...
                                      <td class="W75" style="display:none">
                                        ...
                                        <div id="<!--{$key}-->_area">
                                          ...
                                          <ul class="W100">
                                            <li id="<!--{$key1}-->_li" class="inline"><input placeholder="手機條碼" type="text" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->;" class="box300" onchange="onChangeCarrierNumber();" />&nbsp;</li>
                                            <li id="<!--{$key2}-->_li" class="inline"><input placeholder="自然人憑證條碼" type="text" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->;" class="box300" onchange="onChangeCarrierNumber();" /></li>
                                          </ul>
                                        </div>
                                  ...
                                  <tr>
                                    <!-- // FIXME:假pay_area02 -->
                                      ...
                                      <div class="pay_area02">
                                        <div class="W100">
                                            <span class="attention">錯誤訊息</span>
                                            <textarea name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" cols="70" rows="2" class="txtarea border_round W100" wrap="hard" maxlength="15" placeholder=" (最多15個字)"></textarea>
                                        </div>
                                      </div>

                                    <!-- // FIXME:真pay_area02 -->
                                      <div class="pay_area02" style="display:none;">
                                        <div class="W100">
        ...
        <div class="btn_area">
          <a href="?mode=return" class="btn f_black bg_white mr15" id="back03">返回修改</a>
          <button name="send_button" class="btn f_white bg_red" name="next" id="next" >下一步</button>
        </div>
         <!--   肚子結束  -->
  </div>
</div>
...
<script>
    $(function(){
        ...
        $('#card_detail, #card_used_info').each(function(){
    ...
    $('body').on('click','button',function(e){
        e.preventDefault();
        window.location="/manara_site/shopping/confirm.php";
    })
