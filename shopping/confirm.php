                            ...
                            <form name="form1" id="form1" method="post" action="?">
                                ...
                                <table summary="ご注文内容確認/" class="product-table padding20" >
                                    <tr class="f15 t_left">
                                        ...
                                        <th scope="col" class="W17 border_0 mb-25">小計</th>
                                    </tr>
                                    <!-- //FIXME 砍假tr -->
                                    <tr>
                                        <td class="mb-50">
                                        ...
                                        <td class="alignR mb-25">
                                            NT$1,110
                                            <font class="mb">x1</font>
                                        </td>
                                        <td class="alignR mb_none">1</td>
                                        <td class="alignR f_red mb-25">NT$1,110</td>
                                    </tr>
                                    ...
                                    <tr style="display:none">
                                        ...
                                        <td class="alignR mb_none"><!--{$item.quantity|number_format}--></td>
                                        <td class="alignR f_red mb-25">NT$<!--{$item.total_inctax|number_format}--></td>
                                    </tr>
                                    <!--{/foreach}-->
                                    ...
                                    <tr class="form_final">
                                        <td colspan="4" class="t_right" scope="row">
                                            <div class="W100">
                                                <span>商品金額</span>
                                                <span class="W25">NT$1,110</span>
                                            </div>
                                            <div class="W100">
                                                <span>運費</span>
                                                <span class="W25">NT$70</span>
                                            </div>
                                            <div class="W100">
                                                <span>手續費</span>
                                                <span class="W25">NT$0</span>
                                            </div>
                                            <div class="W100">
                                                <span>合計</span>
                                                <span class="price W25 f24 f_red f_b">NT$1,180</span>
                                            </div>
                                        </td>
                                    ...
                                    <!-- //FIXME 真tr們 -->
                                    <tr class="form_final" style="display:none">
                                        <td colspan="4" class="t_right" scope="row">
                                            <div class="W100">
                                                <span>商品金額</span>
                                ...
                                <!-- //FIXME 真table -->
                                <table summary="ポイント確認/" class="delivname" style="display:none">
                                    <col width="30%" />
                                    <col width="70%" />
                                    <tr>
                                ...
                                <h5 class="title f21 f_black t_left">送貨地址</h5>
...
<script>
    ...
    $('body').on('click','button',function(e){
        e.preventDefault();
        window.location="/manara_site/shopping/complete.php";
    })
