...
<!-- new nav start -->
    ...
    <nav class="nav-phone">
        ...
        <div class="icon-box">
            <a href="https://www.manara.asia/tw/mypage/login.php">
                <img src="https://www.manara.asia/tw/user_data/new/img/icon-user.png" alt="會員登入">
            </a>
            <a href="https://www.manara.asia/tw/cart">
                <img src="https://www.manara.asia/tw/user_data/new/img/icon-cart.png" alt="購物車">
            </a>
        </div>
    </nav>
        ...
        <ul class="menu-content-box">
            ...
            <li class="menu-2nd-box">
                <ul>
                    ...
                    <li>
                        <a href="https://www.manara.asia/tw/user_data/product1.php">溫熱卸妝凝膠 按摩PLUS</a>
                    </li>
                    <li>
