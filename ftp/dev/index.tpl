    ...
    <div class="W1200 t_left columns-12">
        <div class="col-md-7 col-sm-6 col-xs-6 video_wrap">
            ...
            <iframe width="100%" height="100%"
                src="https://www.youtube.com/embed/T3-ALca5-eI?loop=1&playlist=T3-ALca5-eI" allowtransparency="true"
        ...
        mounted() {
            ...
            this.$nextTick(function () {
                ...
                mc.on("swipeleft swiperight", function (ev) {
                    ...
                    if (ev.type === "swipeleft" && $this.slide_current < $this.banners_pc
                        .length - 1) {
                    ...
                    $('img, a, link').each(function () {
                        ...
                        if (el === 'IMG') {
                            var current_src = $(this).attr('src').replace(
                                '<!--{$smarty.const.ROOT_URLPATH}-->', '/manara_site/').replace(
                                '<!--{$smarty.const.HTTPS_URL}-->', '/manara_site/');
