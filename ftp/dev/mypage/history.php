        ...
        <div class="bg_l_pink clearfix pd20">
            ...
            <form action="order.php" method="post">
                ...
                <p>
                    ...
                    <button name="submit" value="この購入内容で再注文する" class="btn f_white bg_red">再次放入購物車</button>
<!--{*                    <input type="hidden" name="order_id" value="<!--{$tpl_arrOrderData.order_id|h}-->">
        ...
        <table summary="購入商品詳細/" class="mypage_table">
            ...
            <!--{/foreach}-->
            <tr>
                <td colspan="3" class="alignR">小計</th>
            ...
            <!--{if $point_discount > 0}-->
            <tr>
                <td colspan="3" class="alignR">紅利點數折扣</th>
        ...
        <div style="display: flex;align-items: center;padding: 20px 10px 10px 0;">
            ...
            <form name="form1" method="post" action="?">
                ...
                <a href="/tw/mypage/history_edit.php?order_id=<!--{$tpl_arrOrderData.order_id}-->" class="btn f_white bg_red">修改</a>
            </form>
            <!--{/if}-->
        </div>
            <!--{if $isMultiple}-->
...
*}-->
        ...
        <div class="btn_area">
            <ul>
                <li>
                    <a href="./<!--{$smarty.const.DIR_INDEX_PATH}-->" class="btn bg_red f_white" id="change" >
                        返回
                    </a>
                </li>
            </ul>
