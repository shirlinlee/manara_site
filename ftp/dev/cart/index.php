                            ...
                            <tr class="f18">
                                ...
                                <td class="W17 mb_none t_center">
                                    <div class="counting_area">
                                        <!--{$item.quantity}-->
                                        <a href="?" onclick="fnFormModeSubmit('form<!--{$key}-->','down','cart_no','<!--{$item.cart_no}-->'); return false;" class="count_btn bg_black btn"></a>
                                        <a href="?" onclick="fnFormModeSubmit('form<!--{$key}-->','up','cart_no','<!--{$item.cart_no}-->'); return false;" class="count_btn bg_red btn"></a>
                                    </div>
                                </td>
