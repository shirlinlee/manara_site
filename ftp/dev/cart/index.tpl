<!--   肚子開始  -->
    ...
    <div class="W100 t_center">
      <div class="W1360 bread">
          <span class="f15 f_pink f_left"><a class="f_grey" href="/tw/">首頁 /</a> <a class="f_grey" href="/tw/user_data/product_list.php">MANARA商品 / </a> 購物清單</span>
      </div>
    </div>
    <div class="container sec-wrap">
        <div id="main_text">
            <div id="shoppingCart">
                <h3 class="f21 t_left">購物清單</h3>
                    ...
                    <form name="form<!--{$key}-->" id="form<!--{$key}-->" method="post" action="?">
                        ...
                        <div class="btn_area">
                            <ul class="submit-button">
                                <a href="../user_data/product_list.php" class="btn f_black bg_white mr15">繼續購物</a>
