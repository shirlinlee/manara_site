         ...
         <div class="main-content">
             ...
             <div class="qa-col-12">
                 ...
                 <div class="col-3 js-qa-list-screen qa-list-screen hide_phone">
                     <ul>
                         <li>
                             <a class="js-tab-btn" :class="{'active': current_tab === index}" href="javascript:void(0)"
                                 v-for="(item,index) in faq" @click="tabHandler(index)">
                                 <div>
                                     <img :src="imgSrc(item.icon)" alt="MANARA的常見問題">
                                 </div>
                                 <p>{{ item.title }}</p>
                 ...
                 <div class="col-9 pt-1">
                     ...
                     <div class="js-tab-content qa-tab-content" :class="{'active': index === current_tab}"
                         v-for="(item,index) in faq" :ref="'tab'+index" v-show="index === current_tab">
                         ...
                         <div class="qa-card-box" v-for="(q,i) in item.qa">
                             <div class="qa-card">
                                 <div class="js-card-title qa-card-title qa-open"
                                     ...
                                     :id="index+'_qus_'+i">{{ q.question }}</div>
         ...
         methods: {
             ...
             openSpecificCat(cat) {
                 ...
                 setTimeout(() => {
                     ...
                     $body.animate({
                         scrollTop: $(this.$refs[
                                 `${this.current_tab}_ans_${this.getUrlParameter('q')}`])
                             .offset().top - (this.isMobile() ? 120 : 170)
                     }, 50);
