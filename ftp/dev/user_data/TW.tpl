  ...
  <div id="_product">
      <div class="sec1">
          <div class="product_pic W50 f_left" style="background-image: url(new_201811/img/product/ns/main-img-ns.jpg)">
              <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/ns/main-img-m-ns.jpg"
                  class="mb" alt="">
          </div>
      ...
      <div class="sec2 W100">
          <h2 class="f40 CJK_b f_white">榮獲「世界品質評鑑大賞」金賞的肯定</h2>
      </div>
      <div class="sec3 W100 bg_blue">
          ...
          <div class="W1200 bg_white">
              <div class="W100 W960">
                  <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/ns/banner-ns-001.jpg"
                      alt="" class="pc">
      ...
      <div class="sec7 W100">
          <ul class="use_step W100">
              <li>
                  <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/ns/img-ns-step-1.jpg"
                      alt="">
                  <p class="f21 f_b">取約50元硬幣大小的量</p>
                  <p class="f15">於掌心中取50元硬幣大小的量。</p>
              </li>
              <li>
                  <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/ns/img-ns-step-2.jpg"
                      alt="">
              ...
              <li>
                  <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/ns/img-ns-step-3.jpg"
                      alt="">
      ...
      function onYouTubeIframeAPIReady() {
          window.YT.ready(function () {
              ...
              player = new YT.Player('YouTubeVideoPlayerAPI', {
                  videoId: 'szoumoMuWig', // YouTube 影片ID
                  playerVars: {
                      autoplay: 1, // 自動播放影片
                      controls: 0, // 顯示播放器
                      showinfo: 0, // 隱藏影片標題
                      ...
                      loop: 1, // 重覆播放
                      playlist: 'szoumoMuWig', // 當使用影片要重覆播放時，需再輸入YouTube 影片ID
                      fs: 0, // 隱藏全螢幕按鈕
