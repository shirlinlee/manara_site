        ...
        <div id="_product">
                ...
                <div class="sec7 W100">
                    ...
                    <div class="W1200 video_wrap">
                        <div class="W67">
                            ...
                            <iframe width="100%" class="poA" src="https://www.youtube.com/embed/HL1LnSnpMc0?loop=1&rel=0&showinfo=0&color=white&iv_load_policy=3&playlist=UUoJaqIrZps" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                ...
                <div class="sec8 W100">
                    <div class="info_table W1200 f15">
                        ...
                        <div class="W100">
                            <div class="th">成分</div>
                            <div class="td">溫泉水、甘油三（乙基己酸）、酯丁二醇、 鯨蠟醇乙基己酸酯、水、 雙丙甘醇、甘油、1,2-戊二醇、雙-二乙氧基二甘醇環己、1,4-二羧酸酯、水解膠原蛋白、角鯊烷、羥丙基三甲基氯化銨、透明質酸、透明質酸鈉、水解透明質酸、乙醯化透明質酸鈉、羧甲基透明質酸鈉、ALPHA-熊果素、抗壞血酸磷酸酯鎂、野薔薇果萃取、醉蝶花葉萃取、菜薊葉萃取、木瓜蛋白脢、抗壞血酸四異棕櫚酸酯、來檬汁、甜橙汁、香櫞汁、蘋果果萃取、棗果萃取、野山楂果萃取、柚果萃取、黃蘖樹皮萃取、精氨酸、雙甘油、糖基海藻糖、氫化澱粉水解物、丙烯酸(酯)類／C10-30烷醇丙烯酸酯交聯聚合物、 1,2-己二醇 、丙烯酸羥乙酯／丙烯醯二甲基牛磺酸鈉共聚物、 苧烯、 聚甘油-10 、肉豆蔻酸酯、 棕櫚酸乙基己酯、 二甲基甲矽烷基化矽石、 聚山梨醇酯 60 、乙基己基甘油、 黃原膠、 辛甘醇、 藻酸鈉、 氰鈷胺、 卡波姆、 1,3-丙二醇、 噴替酸五鈉 、苯氧乙醇</div>
                        </div>
                    </div>
                </div>
