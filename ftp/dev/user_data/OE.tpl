                ...
                <div class="W67">
                    ...
                    <div class="t_left">
                        ...
                        <p class="f18">
                            ...
                            使用。<br />
                            <font class="f_red f_b">極潤型</font> 濃厚乳霜狀。能僅僅鎖住肌膚表面油份和水分，推薦<font class="f_b">乾燥肌</font>使用。
                        </p>
        ...
        <div class="W1200 video_wrap">
            <div class="W67">
                <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/video_frame.png" alt=""
                    width="100%">
                <iframe width="100%" class="poA" src="https://www.youtube.com/embed/ivnChpGRjQs" frameborder="0"
