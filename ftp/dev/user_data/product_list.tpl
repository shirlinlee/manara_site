         ...
         var app = new Vue({
                ...
                data: {
                    ...
                    wash:[{name:'溫熱卸妝凝膠',en_name:'HOT CLEANING GEL',time:'夜間',link:'CG.php',imgSrc:'new_201811/img/product/list/cg.png',des:'含91.3%美容精華液<br>溫感打開毛孔<br>卸妝洗臉2合一',price:'$1,390',volumn:'200g (約60日份)'},
                        {name:'深層毛孔洗顔凝膠',en_name:'MOIST WASH GEL',time:'日間',link:'MG.php',imgSrc:'new_201811/img/product/list/mg.png',des:'新開發無水洗臉<br>98.8%美容液預防乾燥<br>改善黑頭',price:'$1,200',volumn:'120ml (約60日份)'},
