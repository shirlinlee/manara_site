...
<div class="block_outer">
    ...
    <h2><img src="<!--{$TPL_URLPATH}-->img/title/icon_bloc_calender.gif" alt="Calendar" /><span class="title">行事曆</span></h2>
            ...
            <!--{section name=num loop=$arrCalendar}-->
                ...
                <!--{section name=cnt loop=$arrCal}-->
                    <!--{if $smarty.section.cnt.first}-->
                        <table>
                            <caption class="month"><!--{$arrCal[cnt].year}-->年<!--{$arrCal[cnt].month}-->月 之公休日</caption>
