<div class="W100 t_center">
    <div class="W1360 bread">
        <span class="f15 f_pink f_left"><a class="f_grey" href="/tw/">首頁 /</a>
            <font class="f_grey">會員中心 / </font>訂單查詢
        </span>
    </div>
</div>
...
<div id="mypagecolumn" class="container sec-wrap">
    ...
    <div id="mycontents_area">
        ...
        <div class="bg_l_pink clearfix pd20">
            <p>
                <span class="st">購買時間:&nbsp;</span>
                <!--{$tpl_arrOrderData.create_date|sfDispDBDate}--><br />
                ...
                <!--{/if}-->
                <!--{if $tpl_arrOrderData.return_status == 200}-->退貨申請中
                <!--{elseif $tpl_arrOrderData.return_status == 300}-->委託收取退貨中
                <!--{elseif $tpl_arrOrderData.return_status == 400}-->已派車往前收取退貨
                <!--{elseif $tpl_arrOrderData.return_status == 500}-->等待退款流程
                <!--{elseif $tpl_arrOrderData.return_status == 900}-->已完成退款
                <!--{/if}-->
                <br />
                <span class="st">購入方法:&nbsp;</span>
                <!--{if $tpl_arrOrderData.regular_purchase_flg == 0}-->單回
                <!--{else}-->定期（
                <!--{$tpl_arrOrderData.current_delivery_number_of_time}-->回）
                <!--{/if}--><br />
                <span class="st">支付方法:&nbsp;</span>
                <!--{$tpl_arrOrderData.payment_method|h}-->
            </p>
            ...
            <tr>
                <td>
                    ...
                    <a<!--{if $orderDetail.enable}--> href="
                        ...
                        "
                        <!--{/if}-->>
                        <!--{$orderDetail.product_name|h}--></a><br />
        ...
        <table summary="使用ポイント/" class="mypage_table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{$tpl_arrOrderData[$key]|number_format|default:0}--> pts</td>
            </tr>
            <tr>
                <th class="alignL">本次將新增之紅利點數</th>
                <td>
                    <!--{$tpl_arrOrderData.add_point|number_format|default:0}--> pts</td>
            </tr>
        </table>
        <!--{/if}-->
        <!-- 使用ポイントここまで -->
        ...
        <table summary="お届け内容確認/" class="mypage_table">
            ...
            <tr>
                ...
                <!--{* XXX 購入小計と誤差が出るためコメントアウト
                        <td>NT$<!--{$item.total_inctax|number_format}-->
                </td>
                *}-->
            </tr>
            <!--{/foreach}-->
        ...
        <table summary="送貨地址" class="delivname mypage_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!--{$shippingItem.conv_store_spot|h}-->
                    </td>
                </tr>
                <tr>
                    <th class="alignL">超商名</th>
                    <td>
                        <!--{$shippingItem.conv_store_name|h}-->
                    </td>
                </tr>
                <tr>
                    <th class="alignL">超商地址</th>
                    <td>
                        <!--{$shippingItem.conv_store_addr|h}-->
                    </td>
                </tr>
                <tr>
                    <th class="alignL">超商電話</th>
                    <td>
                        <!--{$shippingItem.conv_store_tel|h}-->
                    </td>
                </tr>
                <!--{else}-->
                <tr>
                    ...
                    <td>
                        ...
                        <!--{$shippingItem.shipping_name02|h}-->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!--{$shippingItem.shipping_addr01|h}-->
                        <!--{$shippingItem.shipping_addr02|h}-->
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <!--{if strlen($shippingItem.shipping_tel02)}-->/&nbsp;
                        <!--{$shippingItem.shipping_tel02}-->
                        <!--{/if}-->
                        <!--{if strlen($shippingItem.shipping_tel03)}-->/&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!--{/if}-->
                        <!--{if strlen($shippingItem.shipping_fax03)}-->/&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <!--{$tpl_arrOrderData.delivery_cycle}-->天</td>
                </tr>
                <!--{/if}-->
            </tbody>
        ...
        <tr class="center">
            ...
            <td class="alignC">
                <!--{$arrMAILTEMPLATE[$key]|h}-->
            </td>
            <td><a href="#"
                    onclick="win02('./mail_view.php?send_id=<!--{$tpl_arrMailHistory[cnt].send_id}-->','mail_view','650','800'); return false;">
                    <!--{$tpl_arrMailHistory[cnt].subject|h}--></a></td>
        </tr>
        <!--{/section}-->
        </table>
        *}-->
