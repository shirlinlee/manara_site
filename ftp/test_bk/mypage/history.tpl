...
<!--{*                    <input type="hidden" name="order_id" value="<!--{$tpl_arrOrderData.order_id|h}-->">
        ...
        <div style="display: flex;align-items: center;padding: 20px 10px 10px 0;">
            ...
            <form name="form1" method="post" action="?">
                ...
                <a href="/tw/mypage/history_edit.php?order_id=<!--{$tpl_arrOrderData.order_id}-->" style="padding: 10px 30px;background:#d3a443;font-size: 14px;margin-left: 20px;color: #FFF;">編集</a>
            </form>
            <!--{/if}-->
        </div>
            <!--{if $isMultiple}-->
