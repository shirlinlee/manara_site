...
<div id="mypagecolumn" class="container sec-wrap">
    ...
    <div id="mycontents_area">
        ...
        <!--{if $tpl_linemax > 0}-->
            ...
            <p> 有<span class="attention"><!--{$tpl_linemax}--> 件</span> 《我的最愛》商品</p>
            <div class="paging">
                <!--▼ページナビ-->
                <!--{$tpl_strnavi}-->
                <!--▲ページナビ-->
            ...
            <table summary="我的最愛">
                ...
                <tr>
                    ...
                    <th class="alignC">商品照片</th>
                    <th class="alignC">商品名</th>
                    <th class="alignC"><!--{$smarty.const.SALE_PRICE_TITLE}-->(含稅)</th>
                </tr>
                <!--{section name=cnt loop=$arrFavorite}-->
                    <!--{assign var=product_id value="`$arrFavorite[cnt].product_id`"}-->
                    <tr>
                        <td class="alignC"><a href="javascript:fnModeSubmit('delete_favorite','product_id','<!--{$product_id|h}-->');">刪除</a></td>
