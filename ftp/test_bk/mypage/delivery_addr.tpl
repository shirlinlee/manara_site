...
<script type="text/javascript">
  ...
  function zipCodeSelecAction(){
    ...
    $('#zipSearchDialog').dialog('close');
        ...
        <div class="btn_area">
            <ul>
              <li><input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_add_address_complete_on.jpg',this);" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_add_address_complete.jpg',this);" src="<!--{$TPL_URLPATH}-->img/button/btn_add_address_complete.jpg" name="register" id="register" /></li>
            </ul>
        </div>
    </form>
