...
<div id="mypagecolumn" class="container sec-wrap">
    ...
    <div id="mycontents_area">
        ...
        <div class="message">取消會員資格程序已完成。<br />
                感謝您使用會員中心。
            </div>

            <div class="shop_information">
                <p class="name"><!--{$arrSiteInfo.company_name|h}--></p>
                <p>TEL：<!--{$arrSiteInfo.tel01}-->-<!--{$arrSiteInfo.tel02}-->-<!--{$arrSiteInfo.tel03}--> <!--{if $arrSiteInfo.business_hour != ""}-->（對應時間/<!--{$arrSiteInfo.business_hour}-->）<!--{/if}--><br />
