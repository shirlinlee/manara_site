        ...
        <div class="index_banner">
            ...
            <ul class="index_slider" id="index_slider" :style="{'width': slideWidth, 'marginLeft':slideLeft}">
                <li v-for="(banner,i) in banners_pc"
                    :style="{ 'background-image': 'url('+bannerLinkHandler(banner.image,i)+')' } ">
                    <a :href="banner.link"></a>
                </li>
            </ul>

            <div class="dots_wrapper">
                <span v-for="(banner,i) in banners_pc" :class="{'active': slide_current==i }"
                    @click="sildeHandler(i)"></span>
            </div>
        </div>
        ...
        <div class="bg_pink f_white close_parent" v-if="emergnecy.length">
            <div class="W1200">
                <div id="attention">
                    ...
                    <span href="javascript:;" class="close poA f_white icon-icon-close"
                        @click="attentionHandler"></span>
                </div>
            </div>
        </div>
            ...
            <div class="W1200 columns-12">
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <a href="javascript:;" class="item_pro" @click="windowHref('user_data/CG.php')">
                        <div class="img_wrapper"><img
                                src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/pro_01.png" /></div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <a href="javascript:;" class="item_pro" @click="windowHref('user_data/MG.php')">
                        <div class="img_wrapper"><img
                                src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/pro_02.png" /></div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <a href="javascript:;" class="item_pro" @click="windowHref('user_data/OE.php')">
                        <div class="img_wrapper"><img
                                src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/pro_04.png" /></div>
        ...
        <section id="ceo" class="W1200">
            ...
            <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/img-ceo-pc.png" class="pc W50 f_right"
                alt="">
            <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/img-ceo-m.jpg" class="mb" alt=""
                @click="windowHref('user_data/features.php')">
        ...
        <section id="social">
            <div class="W1200 columns-12">
                ...
                <div class="col-md-8 col-sm-8 ig">
                    ...
                    <iframe src="https://snapwidget.com/embed/636443" ref="ig" class="snapwidget-widget"
        ...
        <div class="lb_wrapper" v-show="lbOpen" :class="{'show':lbOpen}">
            ...
            <div class="lb W960 bg_white">
                ...
                <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/btn-close.svg" class="close poA"
                    alt="" @click="lbHandler">
                ...
                mounted() {
                    ...
                    this.$nextTick(function () {
                        ...
                        mc.on("swipeleft swiperight", function (ev) {
                            ...
                            if (ev.type === "swipeleft" && $this.slide_current < $this
                                .banners_pc.length - 1) {
                ...
                methods: {
                    DevHandler() {
                        ...
                        if (this.isDev) {
                            $('img, a, link').each(function () {
                                ...
                                if (el === 'IMG') {
                                    var current_src = $(this).attr('src').replace(
                                            '<!--{$smarty.const.ROOT_URLPATH}-->', '/manara_site/')
                                        .replace('<!--{$smarty.const.HTTPS_URL}-->', '/manara_site/');
                                    $(this).attr('src', current_src);
                                }
                                if (el === 'LINK' || el === 'A') {
                                    var current_href = $(this).attr('href').replace(
                                        '<!--{$smarty.const.ROOT_URLPATH}-->',
                                        'https://www.manara.asia/tw/').replace(
                    ...
                    fbFrame() {
                        ...
                        if ($(window).innerWidth() <= 450) {
                            ...
                            ($('div.ig').height() > 235) ? $this.container_height = $('div.ig').height(): $this
