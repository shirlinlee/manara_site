    ...
    var app = new Vue({
        ...
        data: {
            ...
            wash: [{
                    ...
                    time: '夜間',
                    link: 'CG.php',
                    imgSrc: 'new_201811/img/product/list/cg.png',
                    des: '含91.3%美容精華液<br>溫感打開毛孔<br>卸妝洗臉2合一',
                    price: '$1,390',
                    volumn: '200g (約60日份)'
                },
                {
                    ...
                    time: '日間',
                    link: 'MG.php',
                    imgSrc: 'new_201811/img/product/list/mg.png',
                    des: '新開發無水洗臉<br>98.8%美容液預防乾燥<br>改善黑頭',
                    price: '$1,200',
                    volumn: '120ml (約60日份)'
                },
                {
                    ...
                    des: '生酵素溶解髒汙<br>保濕礦泥吸附髒污<br>淨化毛孔',
                    price: '$1,200',
                    volumn: '45g (約60日份)'
                }
            ],
            care: [{
                    ...
                    time: '日夜',
                    link: 'OE.php',
                    imgSrc: 'new_201811/img/product/list/oe.png',
                    des: '日本首支添加<br>獨家KEANARIA精華<br>細緻毛孔、修護細紋斑點',
                    price: '$1,800',
                    volumn: '100ml (約60日份)'
                },
                {
                    name: '全效活膚保濕精華露-極潤',
                    en_name: 'ONLY ESSENCE MOIST',
                    time: '日夜',
                    link: 'OE.php',
            ...
            uv: [{
                    name: '防曬美肌噴霧',
                    en_name: 'UV CUT SPRAY',
                    time: '防曬需求使用',
                    link: 'product4.php',
                    imgSrc: 'new_201811/img/product/list/uvc.png',
                    des: 'SPF45  PA++++<br>物理防曬<br>含草本精油驅除蚊蟲',
                    price: '$750',
                    volumn: '70g'
                },
                {
                    name: '防曬美肌蜜粉餅',
                    en_name: 'UV CUT POWDER',
                    time: '防曬補妝需求使用',
                    link: 'product4.php',
                    imgSrc: 'new_201811/img/product/list/uvp.png',
                    des: 'SPF45   PA++++<br>物理防曬<br>遮瑕毛孔抑制出油',
                    price: '$750',
                    volumn: '7g'
                }
            ],
            travel: [{
                ...
                en_name: 'TRAVEL SET',
                time: '旅行隨身攜帶方便',
                link: 'travelset3day.php',
                imgSrc: 'new_201811/img/product/list/ts.png',
                des: '溫熱卸妝凝膠 按摩PLUS (4g) 3包<br>深層毛孔洗顏凝膠 (2ml) 3包<br>毛孔無瑕礦泥洗顏粉 (0.75g) 3包<br>全效活膚保濕精華露 (0.8ml) 6包<br>',
                price: '$400',
                volumn: '各3天分，總共15包'
            }],
            makeup: [{
                ...
                time: '日間',
                link: 'BB.php',
                imgSrc: 'new_201811/img/product/list/bb.png',
                des: '美容液94%配合<br>防曬、飾底、潤色，一次擁有六大功效！<br>質地柔滑，能輕鬆畫出完美妝容。',
                price: '$1250',
                volumn: '7g (約可使用3~4個月)'
            }]
        },
