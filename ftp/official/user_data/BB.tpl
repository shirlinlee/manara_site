...
<div id="_product">
    ...
    <div class="sec1">
        ...
        <div class="W50 poA t_left">
            ...
            <h3 class="f40 CJK">
                <font class="f_red CJK_b">接觸</font>到肌膚的瞬間 就<font class="f_red CJK_b">融化</font>了
            </h3>
    ...
    <div class="sec3 W100 bg_skin">
        ...
        <div class="W1200 bg_white">
            ...
            <div class="intro_2 W960">
                ...
                <div class="details W100">
                    <div class="img_wrapper W40">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-3.jpg"
                            class="W100" alt="">
                    </div>
            ...
            <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/banner-bb-002.jpg"
                class="W960 mb50" style="margin-top: -20px" width="100%" alt="">
            ...
            <div class="intro_3">
                ...
                <div class="point_1 mg pb60 W960">
                    ...
                    <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-point-1-bb-01.jpg"
                        class="W50 f_right" alt="">
                ...
                <div class="point_2 W960" style="background: #fff1ec;">
                    ...
                    <ul class="point_list t_left f18 mt30">
                        <li>
                            <font class="f_pink f_b">一 超柔焦粉末，</font>能均勻地沾附於肌膚上，光線折射後散發出無色差明亮膚色，有效遮瑕斑點、細紋及毛孔。
                        </li>
                        <li>
                            <font class="f_pink f_b">二 凹凸修正防護網，</font>深入肌膚瑕疵處，填平凹洞，讓您的細紋及毛孔自然遮瑕。
                        </li>
                        <li>
                            <font class="f_pink f_b">三 高效亮彩粉末，</font>使用粉色粉末有效使肌膚紅潤有氣色，消除暗沉。
                        </li>
                    </ul>
                    <div class="W100">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-point-2-bb-02.png"
                            width="645" alt="">
                    </div>
                </div>
    ...
    <div class="sec5 W100">
        <div class="W1200">
            <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-boss.jpg" alt=""
                class="people">
            <div class="des">
        ...
        <div class="W1200">
            <div class="W50 inline">
                ...
                <ul class="W100 use_step">
                    <li class="W50">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-step-a-1.jpg"
                            alt="">
                        <p class="f21 f_b">旋轉出奇肌無瑕水感BB棒</p>
                        <p class="f15">旋出5mm長度，於額頭輕抹1道、臉頰２〜3道粉底。</p>
                    </li>
                    <li class="W50">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-step-a-2.jpg"
                            alt="">
            ...
            <div class="W50 inline">
                ...
                <ul class="W100 use_step">
                    <li class="W50 hidden_arrow">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-step-b-1.jpg"
                            alt="">
                        <p class="f21 f_b">在意毛孔的您</p>
                        <p class="f15">旋出5mm長度，於額頭輕抹1道、臉頰２〜3道粉底。</p>
                    </li>
                    <li class="W50">
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-step-b-2.jpg"
                            alt="">
                        <p class="f21 f_b">在意斑點的您</p>
                        <p class="f15">用指腹沾取奇肌無瑕水感BB後，在斑點處用指腹輕輕按壓堆疊，自然遮瑕。<br /><img
                                src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-bb-step-b-3.jpg"
                                class="step_img" /></p>
                    </li>
                </ul>
            </div>
        ...
        <div class="W1200 video_wrap">
            <div class="W67">
                <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/video_frame.png" alt=""
                    width="100%">
                <iframe width="100%" class="poA" src="https://www.youtube.com/embed/wFIX3JCS5Ec" frameborder="0"
    ...
    <div class="sec8 W100">
        <div class="info_table W1200 f15">
            ...
            <div class="W100">
                <div class="th">成分</div>
                <div class="td">
                    異十三醇異壬酸酯、氧化鈦、聚二甲基矽氧烷、二苯基甲矽烷氧基苯基聚三甲基矽氧烷、氧化鋅、月桂醯離胺酸、聚乙烯、去水山梨糖醇異硬脂酸酯、三異辛酸甘油酯、合成蠟、（二甲基矽氧烷/乙烯基二甲基矽氧烷）聚合物、聚甲基矽氧烷、二氧化矽、玻尿酸鈉、水解玻尿酸、乙基玻尿酸鈉、神經醯胺３、神經醯胺６Ⅱ、神經醯胺２、水解膠原蛋白、葛根根部萃取物、黃豆種子萃取物、月見草種子萃取物、七葉樹種子萃取物、石榴果實萃取物、3-O-乙基抗壞血酸、α-熊果素、熊果素、抗壞血酸二棕櫚酸酯、抗壞血酸四己基癸酸酯、抗壞血酸棕櫚酸酯磷酸酯三鈉、朝鮮薊葉萃取物、甘油、二十二醇、水、BG、乳油木果油、雲母、硬脂醇甘草酸酯、生育酚、水合二氧化矽、堪地理拉蠟、戊二醇、蔗糖醋酸硬脂酸酯、氫化二甲基矽氧烷、聚甘油-10
                    五硬脂酸酯、硬脂醯乳酸鈉、植物固醇異硬脂酸酯、氧化鐵、氫氧化鋁</div>
            </div>
        </div>
    </div>
