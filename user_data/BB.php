        ...
        <div id="_product">
                    ...
                    <div class="W1200 bg_white">
                        ...
                        <div class="intro_3">
                            <div class="point_1 W960">
                                ...
                                <div class="face">
                                    <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-point-1-bb-01.jpg" class="W50" alt="">
                                    <font class="poA"><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/icon/arrow.svg" alt=""></font>
                                    <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-point-1-bb-02.jpg" class="W50" alt="">
                            ...
                            <div class="point_2 bg_yellow W960">
                                ...
                                <ul class="point_material t_left f15">
                                    <li><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/ingredient-bb-1.png" alt=""><span>ケアナリア <br>（KEANARIA）</span></li>
                                    <li><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/ingredient-bb-2.png" alt=""><span>朝鮮薊葉<br class="mb">萃取精華</span></li>
                                    <hr class="mb">
                                    <li><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/ingredient-bb-3.png" alt=""><span>膠原蛋白</span></li>
                                    <li><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/ingredient-bb-4.png" alt=""><span>玻尿酸</span></li>
                            ...
                            <div class="point_3 W960">
                                ...
                                <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-point-3-bb-03.jpg" class="W50 f_right bb" alt="">
                            </div>
                ...
                <div class="sec7 W100">
                    <ul class="use_step W100">
                        <li>
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-step-1.jpg" alt="">
                        <p class="f21 f_b">手乾臉乾的狀態下</p>
                        <p class="f15">於手掌中取10元硬幣大小，兩手合併輕揉凝膠，手溫使之軟化後，於全臉塗開。</p>

                        </li>
                        <li>
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-step-2.jpg" alt="">
                        <p class="f21 f_b">輕柔按摩，<br class="mb">溶解彩妝髒污</p>
                        <p class="f15">指腹輕柔按摩臉部約1分鐘即可。</p>
                        </li>
                        <li>
                        <img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/img-step-3.jpg" alt="">
                    ...
                    <div class="day_night f21">
                        <div class="W40">
                            ...
                            <ul class="W100">
                                <li class="W50">
                                    <div class="img_wrapper" style="background-color:#ffc149"><img src="<!--{$smarty.const.HTTPS_URL}-->user_data/new_201811/img/product/bb/bb.png" alt=""></div>
