        ...
        <div id="detailrightbloc">
            ...
            <!--{if $arrProduct.price01_min_inctax > 0}-->
                <dl class="normal_price">
                    <dt><!--{$smarty.const.NORMAL_PRICE_TITLE}-->(含稅):</dt>
                    <dd class="price">
            ...
            <!--★販売価格★-->
            <dl class="sale_price" style="margin-bottom: 10px;">
                <dt><!--{$smarty.const.SALE_PRICE_TITLE}-->(含稅):</dt>
                <dd class="price">
            ...
            <!--★商品コード★-->
            <dl class="product_code" style="margin: 10px 0;">
                <dt>商品編號:</dt>
                <dd>
...
<!--{* 【追加】 *}-->
            <!--★定期★-->
            <dl class="regular_purchase_flg">
              <dt>定期:</dt>
              <dd>
                <input type="radio" name="regular_purchase_flg" value="1" checked="checked">定期
                <input type="radio" name="regular_purchase_flg" value="0">都度
              </dd>
            </dl>
            ...
            *}-->
            ...
            <!--{if $tpl_stock_find}-->
                    ...
                    <div class="classlist">
                        ...
                        <ul class="clearfix">
                            ...
                            <li>
                                ...
                                <br /><span class="attention">* 請填入 <!--{$tpl_class_name1}--></span>
                                <!--{/if}-->
                            </li>
                        </ul>
                        <!--▲規格1-->
                        ...
                        <ul class="clearfix">
                            ...
                            <li>
                                ...
                                <br /><span class="attention">* 請填入 <!--{$tpl_class_name2}--></span>
                                <!--{/if}-->
                            </li>
                        </ul>
                        <!--▲規格2-->
                ...
                <dl class="quantity" style="display:none;">
                    <dt>數量:</dt>
                    <!--{* 数量が１固定のためhiddenで値を渡す <dd><input type="text" class="box60" name="quantity" value="<!--{$arrForm.quantity.value|default:1|h}-->" maxlength="<!--{$smarty.const.INT_LEN}-->" style="<!--{$arrErr.quantity|sfGetErrorColor}-->" /> *}-->
                    <dd><input type="hidden" class="box60" name="quantity" value="1" maxlength="<!--{$smarty.const.INT_LEN}-->" style="<!--{$arrErr.quantity|sfGetErrorColor}-->" />
                        <!--{if $arrErr.quantity != ""}-->
                ...
                <!--<span style="color:red">※已經在購物車內的商品在更改商品數量後,將無法享有多瓶折扣優惠。
                 如要享有訂購多瓶以上的折扣優惠,請重新至商品一覽當中訂購。另外最多限訂購5瓶。<span><br>-->

                <div class="cartin">
                    <div class="cartin_btn">
                        <div id="cartbtn_default">
                            <!--★カゴに入れる★-->
<!--{*                            <a class="bt03" href="javascript:void(document.form1.submit())">放入購物車</a> *}-->
                            <a href="javascript:void(document.form1.submit())" ><img src="<!--{$TPL_URLPATH}-->img/button/btn_cart_l.jpg" name="cart" id="cart" /></a>
                        </div>
                    </div>
                </div>
                <div class="attention" id="cartbtn_dynamic"></div>
            <!--{else}-->
                <div class="attention">很抱歉！該商品目前缺貨</div>
            <!--{/if}-->
    ...
    <!--{section name=cnt loop=$smarty.const.PRODUCTSUB_MAX}-->
        ...
        <!--{if $arrProduct[$key] != "" or $arrProduct[$ikey]|strlen >= 1}-->
            <div class="sub_area clearfix">
                ...
                <h3><!--★サブタイトル★--><img src="<!--{$TPL_URLPATH}-->img/banner/detail01.jpg" /></h3>
    ...
    <div id="customervoice_area">
      <h2><img src="<!--{$TPL_URLPATH}-->img/banner/detail02.jpg" /></h2>
...
<!--{*                    <a class="bt01" href="./review.php"
                        onclick="win02('./review.php?product_id=<!--{$arrProduct.product_id}-->','review','600','640'); return false;">填寫新評論</a> *}-->
                <!--{/if}-->
            </div>
        </div>
            ...
            <ul>
                <!--{section name=cnt loop=$arrReview}-->
                    <li>
                        ...
                        <p class="voicedate"><!--{$arrReview[cnt].create_date|sfDispDBDate:false}--> 留言者:<!--{if $arrReview[cnt].reviewer_url}--><a href="<!--{$arrReview[cnt].reviewer_url}-->" target="_blank"><!--{$arrReview[cnt].reviewer_name|h}--></a><!--{else}--><!--{$arrReview[cnt].reviewer_name|h}--><!--{/if}--> 推薦標籤:<span class="recommend_level"><!--{assign var=level value=$arrReview[cnt].recommend_level}--><!--{$arrRECOMMEND[$level]|h}--></span></p>
    ...
    <!--{if $arrRecommend}-->
        <div id="whobought_area">
            <h2><img src="<!--{$TPL_URLPATH}-->img/title/icon_product_recommend.png" alt="" /><span class="title">其他推薦商品</span></h2>
            <!--{foreach from=$arrRecommend item=arrItem name="arrRecommend"}-->
                <div class="product_item">
                    ...
                    <div class="productContents">
                        ...
                        <p class="sale_price"><!--{$smarty.const.SALE_PRICE_TITLE}-->(含稅):<span class="price">
                            &#036;
