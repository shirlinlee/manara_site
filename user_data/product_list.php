        ...
        <script>
         var app = new Vue({
                ...
                data: {
                    ...
                    wash:[{name:'溫熱卸妝凝膠 按摩PLUS',en_name:'HOT CLEANSING GEL MASSAGE PLUS',time:'夜間',link:'CG.php',imgSrc:'new_201811/img/product/list/cg.png',des:'含91.3%美容精華液<br>溫感打開毛孔<br>卸妝洗臉2合一',price:'$1,390',volumn:'200g (約60日份)'},
                        ...
                        {name:'毛孔無瑕礦泥洗顏粉',en_name:'TSURULINA WASH',time:'日間',link:'TW.php',imgSrc:'new_201811/img/product/list/ns.png',des:'生酵素溶解髒汙<br>保濕礦泥吸附髒污<br>淨化毛孔',price:'$1,200',volumn:'45g (約60日份)'}],
                    care:[{name:'全效活膚保濕精華露',en_name:'ONLY ESSENCE',time:'日夜',link:'OE.php',imgSrc:'new_201811/img/product/list/oe.png',des:'日本首支添加<br>獨家KEANARIA精華<br>細緻毛孔、修護細紋斑點',price:'$1,800',volumn:'100ml (約60日份)'},
                        {name:'全效活膚保濕精華露-極潤',en_name:'ONLY ESSENCE MOIST',time:'日夜',link:'OE.php',imgSrc:'new_201811/img/product/list/oem.png',des:'日本首支添加<br>獨家KEANARIA精華<br>細緻毛孔、修護細紋斑點',price:'$1,800',volumn:'100ml (約60日份)'}],
                    ...
                    travel:[{name:'旅行隨身組3日份',en_name:'TRAVEL SET',time:'旅行隨身攜帶方便',link:'travelset3day.php',imgSrc:'new_201811/img/product/list/ts.png',des:'溫熱卸妝凝膠 按摩PLUS (4g) 3包<br>深層毛孔洗顏凝膠 (2ml) 3包<br>毛孔無瑕礦泥洗顏粉 (0.75g) 3包<br>全效活膚保濕精華露 (0.8ml) 6包<br>',price:'$400',volumn:'各3天分，總共15包'}],
                    makeup:[{name:'奇肌無瑕水感BB棒',en_name:'BB LIQUID BAR SPF35 PA+++',time:'日間',link:'BB.php',imgSrc:'new_201811/img/product/list/bb.png',des:'美容液94%配合<br>防曬、飾底、潤色，一次擁有六大功效！<br>質地柔滑，能輕鬆畫出完美妝容。',price:'$1250',volumn:'7g (約可使用3~4個月)'}]
                },
                mounted() {
                    var $this = this;
