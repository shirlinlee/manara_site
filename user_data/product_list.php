         ...
         var app = new Vue({
                ...
                data: {
                    ...
                    wash:[{name:'溫熱卸妝凝膠',en_name:'HOT CLEANING GEL',time:'夜間',link:'CG.php',imgSrc:'new_201811/img/product/list/cg.png',des:'含91.3%美容精華液<br>溫感打開毛孔<br>卸妝洗臉2合一',price:'$1,390',volumn:'200g (約60日份)'},
                        ...
                        {name:'毛孔無瑕礦泥洗顏粉',en_name:'NAMA NERI WASH',time:'日間',link:'NS.php',imgSrc:'new_201811/img/product/list/ns.png',des:'生酵素溶解髒汙<br>保濕礦泥吸附髒污<br>淨化毛孔',price:'$1,200',volumn:'45g (約60日份)'}],
