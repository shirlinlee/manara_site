        ...
        <script>
         var app = new Vue({
                ...
                data: {
                    ...
                    travel:[{name:'旅行隨身組3日份',en_name:'TRAVEL SET',time:'旅行隨身攜帶方便',link:'travelset3day.php',imgSrc:'new_201811/img/product/list/ts.png',des:'溫熱卸妝凝膠 (4g) 3包<br>深層毛孔洗顏凝膠 (2ml) 3包<br>毛孔無瑕礦泥洗顏粉 (0.75g) 3包<br>全效活膚保濕精華露 (0.8ml) 6包<br>',price:'$400',volumn:'各3天分，總共15包'}],
